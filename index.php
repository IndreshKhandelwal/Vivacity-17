        ...
        <div class="cover">
            ...
            <div class="cover__link">
                    ...
                    <a href="sponsors.php">Sponsors</a>
                      ...
                      <div class="opsi spon1">
                    <div id="pageone" data-role="main" class="ui-content">
    <a href="#myPopup" data-rel="popup" data-position-to="window">
    Bus TimeTable</a>

    <div data-role="popup" id="myPopup">
      <a href="#pageone" data-rel="back" class="ui-btn ui-corner-all ui-shadow ui-btn-a ui-icon-delete ui-btn-icon-notext ui-btn-right">Close</a><img src="bus.png" style="width:auto;height:auto;" alt="Skaret View">
    </div>
  </div>
                    </div>
                      </div>
            ...
            <section class="cover__scene cover__scene_1">
                ...
                <div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div><div class="ray"></div>
        ...
        <div class="borboleta-radial">
          <div class="borboleta-gfx">
            ...
            <section class="cover__scene cover__scene_2">
                <div class="cover__lines"><img src="assets/i/cover-line-1.png" alt="" class="cover__line cover__line_1" /><img src="assets/i/cover-line-2.png" alt="" class="cover__line cover__line_2" /><img src="assets/i/cover-line-3.png" alt="" class="cover__line cover__line_3" /><img
                            src="assets/i/cover-line-4.png" alt="" class="cover__line cover__line_4" /></div>
                <div class="cover__box">
                    ...
                    </div><img src="assets/i/eye.png" alt="" class="cover__box-img" /><img src="assets/i/eye.gif" alt="" class="cover__box-img" style="position:absolute; right:140px; top:116px;" width="118px"/></div>
                <div class="cover__drops-bottom">
                    <div class="cover__drop cover__drop_1"><img src="assets/i/cover-drop-1.png" alt=""></div>
                    <div class="cover__drop cover__drop_2"><img src="assets/i/cover-drop-2.png" alt=""></div>
                    <div class="cover__drop cover__drop_3"><img src="assets/i/cover-drop-3.png" alt=""></div>
                </div>
            </section>
                    ...
                    <div data-depth="0.05" class="layer">
                        <div class="news__list">
                         <div class="news__list-item">
                                                            <a href="nikon.php" style="text-decoration:none;" target="_blank">
                                    <div class="post">
                                        <div class="post__title">PHOTOGRAPHY </br> NIKON</div>
                                        <div class="post__image"><img src="upload/news/2/2/image/photo.jpg" alt=""></div>
                                        ...
                                        <div class="post__text"><p>"You don't take a photograph.You make it."<br/><span style="margin-left:110px;">- Ansel Adams</span></p>
</div>
                                    </div></a>
                                </div>
                                                            
                                                            <div class="news__list-item">
                                                          <a href="campusprincess.php" style="text-decoration:none;">
                                    <div class="post">
                                        <div class="post__title">CAMPUS <br> PRINCESS <br></div>
                                ...
                                <div class="news__list-item">
                                                            <a href="iplauction" style="text-decoration:none;" target="_blank">
                                    <div class="post">
                                        <div class="post__title">IPL AUCTION</div>
                                ...
                                <div class="news__list-item">
                                                            <a href="masterchef" style="text-decoration:none;" target="_blank">
                                    <div class="post">
                                        <div class="post__title">MASTERCHEF<br></div>
